var codeQuiz = [
  {
    question: "What is the option, when moving to a branch, to create the branch it if it does not exist?",
    a: "-a",
    b: "-b",
    c: "-c",
    d: "-d",
  ...
  {
    question: "If we want to show an Arrow as cursor in CSS, then which value we will use?",
    a: "pointer",
    b: "arrow",
    c: "default",
    d: "clicker",
